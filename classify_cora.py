...
parser.add_argument('--TEST_SET_INDEX',default=0,help='0-4 the index of the 5-fold experiment',type=int)
...
parser.add_argument('--LR_SC', default={ (-1000,2):.005 ,  (2,1e5):.1} , help='Learning rate schedule',type=dict)
